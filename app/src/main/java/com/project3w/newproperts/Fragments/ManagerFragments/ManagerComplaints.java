...
public class ManagerComplaints extends ListFragment {
    ...
    public interface ComplaintTypeListener {
        void callComplaintFragment(String complaintType);
    }

    ComplaintTypeListener onComplaintTypeListener;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (mUser == null) {
            ...
            // attach our listener
            try {
                onComplaintTypeListener = (ComplaintTypeListener) mActivity;
            } catch (ClassCastException e) {
                throw new ClassCastException(mActivity.toString() + " must implement ComplaintTypeListener");
            }
        }

        mActivity.setTitle("Complaint Category");
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        displayItems.add("Active Complaints");
        displayItems.add("Closed Complaints");
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        switch (position) {
            case 0:
                onComplaintTypeListener.callComplaintFragment("active");
                break;
            case 1:
                onComplaintTypeListener.callComplaintFragment("closed");
                break;
        }
